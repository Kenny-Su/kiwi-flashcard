...
export default function FlashcardManager({ api, className }: { api: ApiClient; className?: string }) {
  ...
  const [exportLibrary, setExportLibrary] = useState(false);
